...
| `references/16-planejamento-e-producao.md` | **Quando e quanto produzir.** Cronograma etapa por etapa das 10 mestres, checagem de pré-produção, capacidade de forno como gargalo, que massa escolher por situação, FIFO e descanso de bancada, antecedência, janela de serviço (napolitana × New York), proofer × geladeira, pizza para muita gente e evento |
...
- **O que ainda não está nesta base**: o capítulo de história (vol. 1, cap. 1), o panorama
  mundial em profundidade (vol. 1, cap. 2), o capítulo de viagem e pesquisa de campo (vol. 1,
  cap. 3 — inclui São Paulo e Buenos Aires) e o volume 3 inteiro.
