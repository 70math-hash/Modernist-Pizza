...
description: Motor técnico de pizza baseado no Modernist Pizza (Myhrvold & Migoya), vols. 1 e 2: as 10 massas-mestre e ~30 sub-mestres em percentual de padeiro, as 7 massas sem glúten, as 10 grades de variação, os tempos de mistura de cada massa em cada batedeira, planejamento de produção e escalonamento, física de forno, fermentação e levain, farinha, molhos de tomate e brancos, queijo e queijo caseiro, payload de cobertura e diagnóstico de defeitos. Use SEMPRE que a conversa envolver massa de pizza, hidratação, percentual de padeiro, escalonar receita, glúten, autólise, poolish, levain, biga, fermentação a frio, ponto da massa, abrir ou modelar massa, batedeira e tempo de batida, forno (lenha, gás, deck, esteira, combi, doméstico), aço ou pedra, temperatura e tempo de assagem, leopardagem, cornicione, gum line, escala de produção, pré-assar, molho de tomate, San Marzano, pesto, béchamel, mussarela, fior di latte, burrata, queijo ralado ou vegano, Catupiry, gramagem de cobertura, azeite, sem glúten, ou defeito de pizza ("massa não estica", "fundo queimado", "centro ensopado", "borda murcha"). Dispara também para estilos: napolitana, AVPN, New York, apizza, artisan, al taglio, pala, Detroit, focaccia, deep-dish, thin-crust, brasileira, NY square, romana, Pinsa.
---
